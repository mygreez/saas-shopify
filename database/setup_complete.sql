...
CREATE INDEX IF NOT EXISTS idx_prompt_configs_user ON prompt_configs(user_id);
...
-- ============================================
CREATE TABLE IF NOT EXISTS product_examples (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE INDEX IF NOT EXISTS idx_product_examples_config ON product_examples(prompt_config_id);
...
CREATE INDEX IF NOT EXISTS idx_ai_logs_product ON ai_generation_logs(product_id);
...
DROP TRIGGER IF EXISTS update_prompt_configs_updated_at ON prompt_configs;
